                ...
                <div class="tab-content">
                                    ...
                                    <div class="body" id="profile">
                                        <div class="row">
                                            ...
                                            <div class="col-md-3 col-6 b-r">
                                                ...
                                                <p class="text-muted">{{$user->profile->$state->name}}</p>
                    ...
                    <div role="tabpanel" class="tab-pane" id="usersettings" aria-expanded="false">
                        ...
                        <div class="card-header">
                                <a href="#" class="btn btn-success" data-toggle="modal" data-target="#userModal">تکمیل پروفایل</a>
                           </div>
...
<form action="{{route('profile.store')}}" method="POST" id="profile" enctype="multipart/form-data" class="myform">
                                @csrf

                                <div class="col-xs-12 col-sm-12 col-md-12">
                                    <div class="form-group">
                                        <strong>نام :</strong>
                                        <input type="text" name="first_name" id="first_name" class="form-control myinput" placeholder="Name">
                                    </div>
                                </div>
                                <div class="col-xs-12 col-sm-12 col-md-12">
                                    <div class="form-group">
                                        <strong>نام خانوادگی:</strong>
                                        <input type="text" name="last_name" id="last_name" class="form-control myinput" placeholder="lastname">
                                    </div>
                                </div>
                                <div class="col-xs-12 col-sm-12 col-md-12">
                                    <div class="form-group">
                                        <strong>بیوگرافی:</strong>
                                        <input type="text" name="biography" id="biography" class="form-control myinput" placeholder="biography">
                                    </div>
                                </div>
                                <div class="col-xs-12 col-sm-12 col-md-12">
                                    <div class="form-group">
                                        <strong>علاقه مندی:</strong>
                                        <input type="text" name="favoraite" id="favoraite" class="form-control myinput" placeholder="favoraite">
                                    </div>
                                </div>
                                ...
                                <div class="col-xs-12 col-sm-12 col-md-12">
                                    <div class="form-group">
                                        <strong>استان:</strong>
                                     <select class="form-control" name="province" id="province-drop">
