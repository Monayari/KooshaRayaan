                                            ...
                                            <div class="product-gallery">
                                                <div class="product-gallery-thumbnails">
                                                    <ol class="thumbnails-list list-unstyled">
                                                        <li><img src="{{asset('/images/dashboard/p2.jpg')}}" alt></li>
                                                        <li><img src="{{asset('/images/dashboard/p3.jpg')}}" alt></li>
                                                        <li><img src="{{asset('/images/dashboard/p4.jpg')}}" alt></li>
                                                        <li><img src="{{asset('/images/dashboard/p5.jpg')}}" alt></li>
                                                        <li><img src="{{asset('/images/dashboard/p6.jpg')}}" alt></li>
                                                    </ol>
                                                </div>
                                                <div class="product-gallery-featured">
                                                    <img src="{{asset('/images/dashboard/p1.jpg')}}" alt>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12">
                                            <div class="product-payment-details">
                                                ...
                                                <p><i class="fa fa-credit-card text-success"></i> <strong>بدون هزینه انتشار
                                                        19165 تومان در ماه</strong></p>
                                                <p><i class="fa fa-swatchbook col-cyan"></i> <strong>بانک ارائه می دهد 10٪
                                                        تخفیف فوری در مسترکارت برای اولین پرداخت آنلاین</strong></p>
                                                <p><i class="fa fa-bookmark col-red"></i> <strong>شریک پیشنهاد خرید این لپ
                                                        تاپ و گرفتن 2 سال گارانتی تمدید @ ₹2999</strong></p>
                                                <p><i class="fa fa-credit-card text-success"></i> <strong>بدون هزینه انتشار
                                                        19165 تومان در ماه</strong></p>
                                                <label for="quant">تعداد</label>
                                                <input type="number" name="quantity" min="1" id="quant"
                                                    class="form-control mb-5 input-lg" placeholder="مقدار را انتخاب کنید">
                                    ...
                                    <div class="product-comments">
                                        ...
                                        <form class="form-inline mb-5">
                                            <textarea cols="50" rows="2" class="form-control mr-4"
                                                placeholder="یک سوال بنویس"></textarea><button
                                                class="btn btn-lg btn-primary">پرسیدن</button>
                                        </form>
                                        <h5 class="mb-5">آخرین سوالات</h5>
                                        <ol class="list-unstyled last-questions-list">
                                            <li><i class="fa fa-comment"></i> <span>سلام دیوید، آیا می توانم با کارت
                                                    اعتباری پرداخت کنم؟</span></li>
                                            <li><i class="fa fa-comment"></i> <span>آیا می توانم آن را به آدرس دیگری ارسال
                                                    کنم؟</span></li>
                                        </ol>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12">
                                        ...
                                        <div class="recommended-items card-deck">
                                            <div class="card">
                                                <img src="{{asset('/images/dashboard/p2.jpg')}}" alt class="card-img-top">
                                                <div class="card-body">
                                            ...
                                            <div class="card">
                                                <img src="{{asset('/images/dashboard/p3.jpg')}}" alt class="card-img-top">
                                                <div class="card-body">
                                                    <h5 class="card-title">55000 تومان</h5>
                                                    <span class="text-muted"><small>صندلی متالیک چوبی</small></span>
                                                </div>
                                            ...
                                            <div class="card">
                                                <img src="{{asset('/images/dashboard/p4.jpg')}}" alt class="card-img-top">
                                                <div class="card-body">
                                                    <h5 class="card-title">55000 تومان</h5>
                                                    <span class="text-muted"><small>صندلی متالیک چوبی</small></span>
                                                </div>
                                            ...
                                            <div class="card">
                                                <img src="{{asset('/images/dashboard/p5.jpg')}}" alt class="card-img-top">
                                                <div class="card-body">
                                                    <h5 class="card-title">55000 تومان</h5>
                                                    <span class="text-muted"><small>صندلی متالیک چوبی</small></span>
                                                </div>
...
<script src="{{asset('/js/dashboard/app.min.js')}}"></script>
    ...
    <script src="{{asset('/js/dashboard/product-detail.js')}}"></script>
@endpush
