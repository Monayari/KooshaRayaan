                        ...
                        <div class="body">
                            <div class="recent-comment">
                                <div class="notice-board">
                                    <div class="table-img">
                                        <img class="notice-object" src="{{asset('/images/dashboard/user6.jpg')}}" alt="...">
                                    </div>
                                ...
                                <div class="notice-board">
                                    <div class="table-img">
                                        <img class="notice-object" src="{{asset('/images/dashboard/user4.jpg')}}" alt="...">
                                    </div>
                                    <div class="notice-body">
                                        <p>لورم ایپسوم متن ساختگی با تولید سادگی نامفهوم از صنعت چاپ.</p>
                                ...
                                <div class="notice-board">
                                    <div class="table-img">
                                        <img class="notice-object" src="{{asset('/images/dashboard/user3.jpg')}}" alt="...">
                                    </div>
                                    <div class="notice-body">
                                        <p>لورم ایپسوم متن ساختگی با تولید سادگی نامفهوم از صنعت چاپ.</p>
                                ...
                                <div class="notice-board no-border">
                                    <div class="table-img">
                                        <img class="notice-object" src="{{asset('/images/dashboard/user7.jpg')}}" alt="...">
                                    </div>
                                    <div class="notice-body">
                                        <p>لورم ایپسوم متن ساختگی با تولید سادگی نامفهوم از صنعت چاپ.</p>
                                ...
                                <div class="notice-board no-border">
                                    <div class="table-img">
                                        <img class="notice-object" src="{{asset('/images/dashboard/user9.jpg')}}" alt="...">
                                    </div>
                                    <div class="notice-body">
                                        <p>لورم ایپسوم متن ساختگی با تولید سادگی نامفهوم از صنعت چاپ.</p>
                                ...
                                <div class="notice-board">
                                    <div class="table-img">
                                        <img class="notice-object" src="{{asset('/images/dashboard/user1.jpg')}}" alt="...">
                                    </div>
                                    <div class="notice-body">
                                        <p>لورم ایپسوم متن ساختگی با تولید سادگی نامفهوم از صنعت چاپ.</p>
                                        <small class="text-muted">آرش خادملو | 1 سات پیش</small>
                                ...
                                <div class="notice-board">
                                    <div class="table-img">
                                        <img class="notice-object" src="{{asset('/images/dashboard/user8.jpg')}}" alt="...">
                                    </div>
                                    <div class="notice-body">
                                        <p>لورم ایپسوم متن ساختگی با تولید سادگی نامفهوم از صنعت چاپ.</p>
                                        <small class="text-muted">آرش خادملو | دیروز</small>
                            ...
                            <div class="chat-history" id="chat-conversation">
                                <ul>
                                    <li class="clearfix">
                                        ...
                                        <div class="message other-message float-right"> سلام آیدن، چطوری؟ پروژه چگونه می
                                            آید؟ </div>
                                    </li>
                                    <li>
                                        ...
                                        <div class="message my-message">
                                            <p>آیا ما امروز ملاقات می کنیم؟ پروژه در حال حاضر به پایان رسیده است و من نتایجی
                                                برای نشان دادن شما دارم.</p>
                                            <div class="row">
                                            </div>
                                        </div>
                                    </li>
